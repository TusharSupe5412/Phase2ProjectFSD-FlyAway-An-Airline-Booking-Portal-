...
<%@page import = "com.fly_away.helper.*" %><!DOCTYPE html>
<html>
<head>
					...
					<div class="card">
							...
							<div class="card-body">
							      ...
							      <div class="form-group">
								    ...
								    <input name="user_source" type="text" class="form-control" id="user_source" aria-describedby="emailHelp" placeholder="Enter your source here">
								  </div>
